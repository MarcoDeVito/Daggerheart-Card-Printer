(() => {
  ...
  function makeSheetCropMarks(bleedOn) {
    ...
    function cornerCross(x, y, dirX, dirY) {
      cornerL(x, y, dirX, dirY);
      cornerL(x, y, -dirX, -dirY);
    }
    ...
    for (let row = 0; row < 3; row++) {
      for (let col = 0; col < 3; col++) {
        ...
        if(row===1 && col===1) {
          L=3;
          cornerCross(xRightCut, yTopCut,  +1, -1);
          cornerCross(xRightCut, yBotCut,  +1, +1);
          cornerCross(xLeftCut,  yBotCut,  -1, +1);
          cornerCross(xLeftCut,  yTopCut,  -1, -1);
          L=6;
          continue;
        }
